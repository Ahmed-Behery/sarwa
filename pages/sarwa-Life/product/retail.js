  ...
  return (
    <div>
      <Head>
        ...
        <meta
          name="description"
          content="Sarwa Life provides a variety of life Commercial and Personal Life insurance Plans tailored to meet your personal or commercial needs and goals."
        />
      </Head>
      <div
        className={
