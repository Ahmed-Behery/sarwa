  ...
  return (
    <div>
      <div className={style.why__join + " container " + style.color_green}>
        ...
        <picture>
          <source srcSet="https://contact-clients-dev.s3.amazonaws.com/JoinUsWhy.png" type="image/webp"/>
          <img alt='' src="https://contact-clients-dev.s3.amazonaws.com/JoinUsWhy.png"/>
        </picture>
        
      </div>

      <h2 className={"text-center "+ style.text_yellow}>{t('appFormTitle')}</h2>
      <div
        dir={t('dir')}
        className={
      ...
      >
        <form onSubmit={(e) => handleSubmit(e)} className="mt-4">
          ...
          <div className={style.btn_glob_contain}>
            <button disabled={!verify} onClick={rest} className={style.apply_btn} type="submit">
              {t('applyBtn')}
            </button>
          </div>
        </form>
