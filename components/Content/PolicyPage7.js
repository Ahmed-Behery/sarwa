...
const PolicyPage7 = (props) => {
  const {t,lang} = useTranslation("common");
  const location = useRouter();

  const imgUrl = "https://contact-clients-dev.s3.amazonaws.com/ProdMotorFleetBannar.png";
  const backgroundUrl = "https://contact-clients-dev.s3.amazonaws.com/ProdMotorFleetBackground.png";
        ...
        <div dir={t("dir")} className="container">
          <div className="row ">
            <div className={style.article__card +" col-lg-12 " +style3.policy_title_i}>
              <span className="mb-4"> {t("car_title")}</span>
              <p className={t("text-align") + " pt-4"}>{t("car_content")}</p>
              <p>
                {t("car_content1")} <br /> {t("car_content2")}
                <br /> {t("car_content3")} <br /> {t("car_content4")}
                <br /> {t("car_content5")}
              </p>
            </div>
          </div>
        ...
        <div className="row bg">
          ...
          <div className={"col-lg-6 "+style3.policyForm}>
            <div className={style1.join__form +" my-5"} id={style1.join}>
              <h3 className="text-center text-white">{t("request_car")}</h3>
