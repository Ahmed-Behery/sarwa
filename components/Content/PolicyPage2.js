...
const PolicyPage2 = (props) => {
  const {t,lang} = useTranslation("common");
  const location = useRouter();

  const imgUrl = "https://contact-clients-dev.s3.amazonaws.com/ProdHomeBannar.png";
  const backgroundUrl = "https://contact-clients-dev.s3.amazonaws.com/ProdHomeBackground.png";
          ...
          <div className="row bg mx-0">
            ...
            <div className={"col-lg-6 "+style3.policyForm}>
              <div className={style1.join__form +" my-5"} id={style1.join}>
                <h3 className="text-center text-white"> {t("ho_request")} </h3>
